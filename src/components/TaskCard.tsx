...
function TaskCard({ task, deleteTask, updateTask }: Props) {
   ...
   /* if (isDragging) {
    ...
    flex text-left rounded-xl border-2
    border-rose-500 cursor-grabs relative">Dragging task</div>
        )
    }*/
    if(editMode){
        return(
        ...
        return (
            <div
                ...
                className="bg-mainbackgroundColor p-2.5 h-[100px]
    min-h-[100px] items-center flex text-left rounded-xl hover:ring-2 hover:ring-inset hover:ring-rose-500 cursor-grabs relative task"
                onMouseEnter={() => {
                    setMouseIsOver(true);
                }}
                onMouseLeave={() => {
            ...
            >
                ...
                <p className="my-auto h-[90%] w-full 
